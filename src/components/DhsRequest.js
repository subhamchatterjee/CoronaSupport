					...
					return (
						<div className="item-row" key={index}>
							...
							<div className="column column-5">
								...
								) : request.status === 'Approved' ? request.approved_qnty : ''}
							</div>
							<div className="column column-6">{request.status !== 'Pending Approval' ? moment(request.approvedAt).format('DD/MM/YYYY') : ''}</div>
