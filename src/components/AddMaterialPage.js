        ...
        return (
            <div className="add-material-page">
                ...
                <div className="d-flex question">
                    ...
                    <textarea className="form-control" value={this.state.desc}
                              onChange={this.changeHandler.bind(this, 'desc')}></textarea>
                </div>
                <div className="d-flex question">
                    <label className="control-label">Unit Price in INR</label>
                    <div className="d-flex input-groups">
                        <input className="form-control" type="number" placeholder="Minimum" value={this.state.min_price}
                               onChange={this.changeHandler.bind(this, 'min_price')}/>
                        <input className="form-control" type="number" placeholder="Maximum" value={this.state.max_price}
                               onChange={this.changeHandler.bind(this, 'max_price')}/>
                    </div>
                </div>
